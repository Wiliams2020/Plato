		                            ...
		                            <div id="stepOne" class="panel-collapse collapse in">
		                                <div class="panel-body">
		                                    ...
		                                    <div class="form-group">
		                                        ...
		                                        <div class="col-lg-5">
													<input class="form-control" id="id_act_num_precio" name="precio" placeholder="Ingrese el número de hombres" type="text" maxlength="2"/>
		                                        </div>
		                                    </div>
		                                    <div class="form-group">
		                                        <label class="col-lg-3 control-label" for="id_num_mujeres">Stock</label>
		                                        <div class="col-lg-5">
													<input class="form-control" id="id_act_stock" name="stock" placeholder="Ingrese el número de mujeres" type="text" maxlength="2"/>
		                                        </div>
		                                    </div>		   
		                                    <div class="form-group">
		                                        <label class="col-lg-3 control-label" for="id_maxima">Restaurante</label>
		                                        <div class="col-lg-5">
													<input class="form-control" id="id_act_restaurante" name="restaurante" placeholder="Ingrese la edad máxima" type="text" maxlength="2"/>
		                                        </div>
		                                    </div>   
		                                    <div class="form-group">
		                                        <label class="col-lg-3 control-label" for="id_minima">Fecha Vencimiento</label>
		                                        <div class="col-lg-5">
													<input class="form-control" id="id_act_fechaVencimiento" name="fechaVencimiento" placeholder="Ingrese la edad mínima" type="text" maxlength="2"/>
		                                        </div>
		                                    </div>    
		                                     <div class="form-group">
		                                        <label class="col-lg-3 control-label" for="id_minima">Ingredientes</label>
		                                        <div class="col-lg-5">
													<input class="form-control" id="id_act_ingredientes" name="ingredientes" placeholder="Ingrese la edad mínima" type="text" maxlength="2"/>
		                                        </div>
		                                    </div>  
		                                    <div class="form-group">
		                                        <label class="col-lg-3 control-label" for="id_act_deporte">Pais</label>
		                                        <div class="col-lg-5">
													<select id="id_act_idPais" name="pais.idPais" class='form-control'>
							                            	<option value=" ">[Seleccione]</option>    
							                         </select>
		                                        </div>
		                                    </div>
...
$.getJSON("cargaPais", {}, function(data, q,t){
	...
	$.each(data, function(index,item){
		...
		$("#id_act_deporte").append("<option value="+item.idPais +">"+ item.nombre +"</option>");
	});
...
function editar(id,nombre,precio,stock,restaurante, fechaVencimiento,ingredientes, idPais){	
	...
	$('select[id=id_act_idPais]').val(idPais);
